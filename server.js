...
// Set proper headers for HTML files and modules
app.use((req, res, next) => {
    // Set proper content types for ES modules
    if (req.path.endsWith('.js') || req.path.includes('/firebase')) {
...
// Also serve the HTML file directly
app.get('/daily-finance-tracker.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'daily-finance-tracker.html'));
});
...
app.get('/index.html', (req, res) => {
    ...
    if (fs.existsSync(indexPath)) {
        ...
        res.redirect('/daily-finance-tracker.html');
    }
});
